...
#------요인추출 실시하기-----
#Principal Component Analysis를 하는 이유
...
# 커뮤넬리티는 주어진 변수 안에 있는 공통분산의 비율이기 때문(23 -> 4 로 줄었음: 추출된 요인들이 설명하는 비율이 당연히 감소)

#------잔차를 통해 요인추출 확인하기-----
#요인 추출이 잘 되었는가? 잔차를 확인해보자
#Explore residuals
